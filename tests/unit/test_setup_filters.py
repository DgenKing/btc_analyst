...
def test_counter_trend_short_setup_requires_high_conviction_score_threshold():
    """Framework rule: high-conviction threshold for counter-trend leverage applies to both long and short setups."""
    cfg = {
        "setups": {
            "min_rr_t1": 1.5,
            "atr_daily_max_pct": 5.0,
